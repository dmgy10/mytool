# -*- coding:utf-8 -*-
"""
@project: UemWeightDesign
@author: HEYF6
@file: ElasticTool.py
@createtime：2019-01-15 09:49:52
"""
...
class ElasticObj:
    def __init__(self, index_name="ott", index_type="ott_type", ip="127.0.0.1"):
        '''
    ...
    def bulk_Index_Data(self):
        ...
        for line in list:
            action = {
                ...
                "_source": {
                    "date": line['date'],
                    "source": line['source'].encode().decode('utf8'),
                    "link": line['link'],
                    "keyword": line['keyword'].encode().decode('utf8'),
                    "title": line['title'].encode().decode('utf8')}
            }
            i += 1
